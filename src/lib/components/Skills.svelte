<script>
    ...
    const t = $derived({
        ...
        en: {
            ...
            designTitle: 'Design',
            design: 'Notion, Figma, Photoshop·Illustrator (GTQ Lv.1), Final Cut·Premiere Pro',
            devTitle: 'Development',
            dev: 'Unreal Engine Blueprint game dev, loading→open level→save/load, data table management · can read C/C++',
            aiTitle: 'AI Creative',
