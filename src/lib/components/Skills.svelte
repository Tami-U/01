<script>
    ...
    const t = $derived({
        ko: {
            ...
            intermediate: '중급',
            designTitle: '디자인',
            design: 'Notion, Figma, 포토샵·일러스트(GTQ 1급), 파이널컷·프리미어프로',
            devTitle: '개발',
            dev: '언리얼 엔진 블루프린트 게임개발, 로딩→오픈레벨→세이브/로드, 데이터테이블 관리 · C/C++ 코드 읽기 가능',
            aiTitle: 'AI 크리에이티브',
        ...
        en: {
            ...
            designTitle: 'Design',
            design: 'Notion, Figma, Photoshop·Illustrator (GTQ Level 1), Final Cut·Premiere Pro',
            devTitle: 'Development',
            dev: 'Unreal Engine Blueprint game development, loading→open level→save/load, data table management · can read C/C++',
